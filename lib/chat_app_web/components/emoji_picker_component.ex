  ...
  def render(assigns) do
    ...
    <div class="relative inline-block" phx-hook="EmojiPicker" id={"emoji-picker-#{@id}"}>
      ...
      <%= if @show_emoji_box do %>
        <div
          class="absolute left-1/2 transform -translate-x-1/2 -translate-y-full z-10"
        ...
        >
          ...
          <div class="w-4 h-4 bg-white border-b border-r border-gray-300 transform rotate-45 absolute left-1/2 -translate-x-1/2 -bottom-2">
          </div>
        </div>
      <% end %>
    </div>
